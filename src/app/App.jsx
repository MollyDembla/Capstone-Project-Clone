	...
	const [asanaCatalog] = useState([
		{
			...
			photoLinks: [
				'/src/assets/step 1 konasana image updated.png',
				'/src/assets/step 2 konasana image updated.png',
				'/src/assets/step 3 konasana image updated.png',
			],
			videoLinks: ['/src/assets/Long Konasana video with music.mp4'],
			...
			tutorialSteps: [
				{
					...
					videoUrl: '/src/assets/Long Konasana video with music.mp4',
				},
				{
					title: 'Step 2',
			...
			<div id="profileModal" className="modal hidden">
				<div className="modal-card">
					...
					<form id="profileForm">
						...
						<label>Height (cm)
							<input id="profileHeightCm" type="number" min="120" max="220" defaultValue="170" required />
						</label>
						<label>Weight (kg)
							<input id="profileWeightKg" type="number" min="30" max="200" defaultValue="70" required />
						</label>
						<label>Flexibility
						...
						<label>Activity Level
							<select id="profileActivityLevel" defaultValue="moderate">
						...
						<label>Eating Habits
							<select id="profileEatingHabits" defaultValue="balanced">
						...
						<label>Sleep (hours/day)
							<input id="profileSleepHours" type="number" min="3" max="12" step="0.5" defaultValue="7" required />
						</label>
				...
				<div className="report-only-grid">
					<section className="panel live-left-panel">
						<div className="webcam-report-actions">
							...
							<button id="viewPipelineBtn" type="button" className="secondary-nav-btn">View Pipeline</button>
						</div>
